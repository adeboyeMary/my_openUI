      ...
      <div className={styles.hero}>
        ...
        <>
          ...
          <p className={styles.p}>
            OpenUI is a flexible, accessible component system for teams who care
            about great products and great code. Built with thoughtful defaults,
            reusable components, and accessibility in mind.
          </p>
        </>
        ...
        <Card className={styles.heroCardContainer}>
          ...
          <form className={styles.form}>
            ...
            <div className={styles.inputDiv}>
              <input placeholder="alex@company.com" className={styles.input} />
